...
object BasinX:
  ...
  given SeqEnumeration[BasinX] = IntEnumeration
...
object BasinZ:
  ...
  given SeqEnumeration[BasinZ] = IntEnumeration
...
given ChunkX Into BasinX = _.toInt >> BasinScaleBits
given ChunkZ Into BasinZ = _.toInt >> BasinScaleBits
