...
object imports:
  ...
  export net.minecraft.core.Direction.*
  export net.minecraft.core.SectionPos.*
  ...
  export net.minecraft.world.level.levelgen.{Heightmap, RandomState, NoiseBasedChunkGenerator, NoiseChunk as NoiseArea}
